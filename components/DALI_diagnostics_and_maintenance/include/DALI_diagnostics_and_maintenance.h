...
#define EXTERNAL_SUPPY_UNDERVOLTAGE 0x11U
#define EXTERNAL_SUPPY_UNDERVOLTAGE_COUNTER 0x12U
#define EXTERNAL_SUPPY_OVERVOLTAGE 0x13U
#define EXTERNAL_SUPPY_OVERVOLTAGE_COUNTER 0x14U
