...
#define LOCK_BYTE 0x02U
#define LIGHT_SOURCE_START_COUNTER_RESETTABLE_MSB 0x04U
#define LIGHT_SOURCE_START_COUNTER_RESETTABLE_2 0x05U
#define LIGHT_SOURCE_START_COUNTER_RESETTABLE_LSB 0x06U
